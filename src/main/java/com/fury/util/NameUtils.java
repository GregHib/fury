...
public class NameUtils {
	...
	static final char[] validChars = { ' ', 'e', 't', 'a', 'o', 'i',
	...
	public static String decode(ByteBuffer stream, int length) {
		char[] message = new char[100];
		int index = 0;

		for (int l = 0; l < length; l++) {
			int in = stream.getUnsignedByte();// received from server
			message[index++] = validChars[in];
		}
	...
	public static String formatNameWithPrefix(String s, boolean stackable){
		String[] strings = {"a", "e", "i", "o", "u"};
		if(stackable) return "some " + s + "s";
