...
public class CharacterAnimations {
	...
	private Revision standingAnimationRevision = Revision.RS2;

	/** The walking animation for this player. */
	private int walkingAnimation = -1;
	private Revision walkingAnimationRevision = Revision.RS2;

	/** The running animation for this player. */
	private int runningAnimation = -1;

	public Revision getStandingAnimationRevision() {
		return standingAnimationRevision;
	}

	public Revision getWalkingAnimationRevision() {
		return walkingAnimationRevision;
	}

	public Revision getRunningAnimationRevision() {
		return runningAnimationRevision;
	}

	private Revision runningAnimationRevision = Revision.RS2;
