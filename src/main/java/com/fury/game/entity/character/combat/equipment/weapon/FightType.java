...
public enum FightType {
    ...
    CHINCHOMPA_SHORTFUSE(2779, 43, 0, BonusManager.ATTACK_RANGE, FightStyle.ACCURATE),
    CHINCHOMPA_MEDIUMFUSE(2779, 43, 1, BonusManager.ATTACK_RANGE, FightStyle.AGGRESSIVE),
    CHINCHOMPA_LONGFUSE(2779, 43, 2, BonusManager.ATTACK_RANGE, FightStyle.DEFENSIVE),
    SALAMANDER_SCORCH(5247, 43, 0, BonusManager.ATTACK_CRUSH, FightStyle.ACCURATE),
    SALAMANDER_FLARE(5247, 43, 1, BonusManager.ATTACK_RANGE, FightStyle.ACCURATE),
    SALAMANDER_BLAZE(5247, 43, 3, BonusManager.ATTACK_MAGIC, FightStyle.ACCURATE);
//579, 952/953
