...
public class GelatinnothMotherCombat extends CombatScript {
    @Override
    public Object[] getKeys() {
        return new Object[] { 3497, "Gelatinnoth Mother" };
    }
    ...
    public int attack(Mob mob, Figure target) {
        ...
        if (Utils.isOnRange(target, mob, 0))
            ...
            delayHit(mob, projectile.getTickDelay(), target, getMagicHit(mob, getRandomMaxHit(mob, MobCombatDefinitions.RANGE, target)));
        }
