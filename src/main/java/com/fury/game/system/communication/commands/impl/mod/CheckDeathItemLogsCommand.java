...
public class CheckDeathItemLogsCommand implements Command {

    private static Pattern pattern = Pattern.compile("^check\\sdeath\\sitem\\slogs\\s(.*)");
    ...
    public String prefix() {
        return "check death item logs ";
    }

    @Override
    public String format() {
        return "check death item logs [username]";
    }
    ...
    public void process(Player player, String... values) {
        ...
        ListWidget.display(player, "Items Dropped on Death Logs: " + target.getUsername(), "", list.toArray(new String[list.size()]));
    }
