...
public class CheckDropLogsCommand implements Command {

    private static Pattern pattern = Pattern.compile("^check\\sdrop\\slogs\\s(.*)");
    ...
    public String prefix() {
        return "check drop logs ";
    }

    @Override
    public String format() {
        return "check drop logs [username]";
    }
    ...
    public void process(Player player, String... values) {
        ...
        ListWidget.display(player, "Npc Drop Logs: " + target.getUsername(), "", list.toArray(new String[list.size()]));
    }
