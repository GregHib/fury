...
public class HouseConstants {
    ...
    public static final Item HAMMER = new Item(2347), SAW = new Item(8794), IRON_BAR = new Item(2351), LIMESTONE_BRICKS = new Item(3420), SOFT_CLAY = new Item(1761), MARBLE_BLOCK = new Item(8786), PLANK = new Item(960), NAILS = new Item(1539), OAK_PLANK = new Item(8778), TEAK_PLANK = new Item(8780),
            MAHOGANY_PLANK = new Item(8782), BOLT_OF_CLOTH = new Item(8790), STEEL_BAR = new Item(2353), GOLD_LEAF = new Item(8784), MOLTEN_GLASS = new Item(1775), MAGIC_STONE = new Item(8788);
    ...
    public static enum Builds {
        ...
        REPAIR_BENCH(15448, false, HObject.REPAIR_BENCH, HObject.WHETSTONE, HObject.ARMOUR_STAND),
        CRAFTING_TABLE(15441, false, true, HObject.CRAFTING_TABLE, HObject.CRAFTING_TABLE_2, HObject.CRAFTING_TABLE_3, HObject.CRAFTING_TABLE_4),
        TOOL_STORE(new int[]{15443, 15444, 15445, 15446, 15447}, false, true, HObject.TOOL_STORE, HObject.TOOL_STORE_2, HObject.TOOL_STORE_3, HObject.TOOL_STORE_4, HObject.TOOL_STORE_5),
        HERALDRY_STAND(15450, false, HObject.PLUMING_STAND, HObject.SHIELD_EASEL, HObject.BANNER_EASEL),
        //GAMES ROOM
        ...
        COMBAT_RING(new int[]{15277, 15278, 15279, 15280, 15281, 15282, 15286, 15287, //ring
                ...
                15291,
                15293,
                15292}, false, HObject.BOXING_RING, HObject.FENCING_RING, HObject.COMBAT_RING), //0 side
        //QUEST ROOM
        ...
        LECTURN(15420, false, HObject.OAK_LECTURN,  HObject.EAGLE_LECTURN, HObject.DEMON_LECTURN, HObject.TEAK_EAGLE_LECTURN, HObject.TEAK_DEMON_LECTURN, HObject.MAHOGANY_EAGLE_LECTURN, HObject.MAHOGANY_DEMON_LECTURN),
        ...
        //MANAGERY
        OBELISK(44911, false, HObject.SMALL_OBELISK),
        PET_FEEDER(44910, false, true, HObject.OAK_PET_FEEDER, HObject.TEAK_PET_FEEDER, HObject.MAHOGANY_PET_FEEDER),
        PET_HOUSE(44909, false, true, HObject.OAK_PET_HOUSE, HObject.TEAK_PET_HOUSE, HObject.MAHOGANY_PET_HOUSE, HObject.CONSECRATED_PET_HOUSE, HObject.DESECRATED_PET_HOUSE, HObject.NATURAL_PET_HOUSE),
        HABITAT(new int[]
                {
                        44843,
                        44844,
        ...
        Builds(int id, boolean water, boolean upgrade, HObject... pieces) {
            this(new int[]{id}, water, upgrade, pieces);
        }

        Builds(int[] ids, boolean water, HObject... pieces) {
            this(ids, water, false, pieces);
        }

        Builds(int[] ids, boolean water, boolean upgrade, HObject... pieces) {
            this.ids = ids;
            this.water = water;
    ...
    public static enum HObject {
        ...
        // WORKSPACE
        //WORKBENCH STOOL - 13179, 13180
        WOODEN_WORKBENCH(8375, 13704, 17, 145, new Item(PLANK, 5), new Item(NAILS, 5)),
        ...
        BENCH_WITH_VICE(8378, 13707, 62, 750, new Item(OAK_PLANK, 2), new Item(STEEL_BAR, 1)),
        BENCH_WITH__A_LATHE(8379, 13708, 77, 1000, new Item(OAK_PLANK, 2), new Item(STEEL_BAR, 1)),
        //REPAIR
        REPAIR_BENCH(8389, 13713, 15, 1000, new Item(OAK_PLANK, 2)),
        WHETSTONE(8390, 13714, 35, 260, new Item(OAK_PLANK, 4), new Item(LIMESTONE_BRICKS, 1)),
        ARMOUR_STAND(8391, 13715, 55, 260, new Item(OAK_PLANK, 8), new Item(LIMESTONE_BRICKS, 1)),
        //HERALDRY
        ...
        //CLOCKMAKING/CRAFTING TABLE
        CRAFTING_TABLE(8380, 13709, 16, 240, new Item(OAK_PLANK, 4)),
        CRAFTING_TABLE_2(8381, 13710, 25, 100, new Item(MOLTEN_GLASS, 1)),
        CRAFTING_TABLE_3(8382, 13711, 34, 175, new Item(MOLTEN_GLASS, 2)),
        CRAFTING_TABLE_4(8383, 13712, 42, 240, new Item(OAK_PLANK, 2)),
        //TOOLS
        TOOL_STORE(8384, new int[]{13699, 13699, 13699, 13699, 13699}, 15, 120, new Item(OAK_PLANK, 2)),
        TOOL_STORE_2(8385, new int[]{13700, 13700, 13700, 13700, 13700}, 25, 120, new Item(OAK_PLANK, 2)),
        TOOL_STORE_3(8386, new int[]{13701, 13701, 13701, 13701, 13701}, 35, 120, new Item(OAK_PLANK, 2)),
        TOOL_STORE_4(8387, new int[]{13702, 13702, 13702, 13702, 13702}, 44, 120, new Item(OAK_PLANK, 2)),
        TOOL_STORE_5(8388, new int[]{13703, 13703, 13703, 13703, 13703}, 55, 120, new Item(OAK_PLANK, 2)),
        //GAMES ROOM
        //COMBAT STONE
        ...
        MEDIUM_STATUE(8083, 13272, 69, 500, new Item(MARBLE_BLOCK, 1)),
        LARGE_STATUE(8084, 13282, 89, 1500, new Item(MARBLE_BLOCK, 3)),
        //WINDOWS
        ...
        //MENAGERIE
        //OBELISK
        SMALL_OBELISK(15236, 44837, 41, 676, new Item(MARBLE_BLOCK, 1), new Item(12183, 1000), new Item(12158, 10), new Item(12159, 10), new Item(12160, 10), new Item(12163, 10)),
        //PET_FEEDER
    ...
    public static enum Room {
        // done
        PARLOUR(100000, 1, 232, 639, true, MapBuilder.EAST, MapBuilder.SOUTH, MapBuilder.WEST)
        // done
        ,
        GARDEN(100000, 1, 232, 633, false, MapBuilder.NORTH, MapBuilder.EAST, MapBuilder.SOUTH, MapBuilder.WEST)
        // done
        ,
        KITCHEN(500000, 5, 234, 639, true, MapBuilder.SOUTH, MapBuilder.WEST)
        // done
        ,
        DINING_ROOM(500000, 10, 236, 639, true, MapBuilder.EAST, MapBuilder.SOUTH, MapBuilder.WEST)
        // done
        ,
        WORKSHOP(1000000, 15, 232, 637, true, MapBuilder.NORTH, MapBuilder.SOUTH)
        // done
        ,
        BEDROOM(1000000, 20, 238, 639, true, MapBuilder.NORTH, MapBuilder.WEST)
        //done
        ,
        HALL_SKILL(1500000, 25, 233, 638, true, MapBuilder.NORTH, MapBuilder.EAST, MapBuilder.SOUTH, MapBuilder.WEST)
        // done
        ,
        GAMES_ROOM(2500000, 30, 237, 636, true, MapBuilder.EAST, MapBuilder.SOUTH, MapBuilder.WEST)
        // done
        ,
        COMBAT_ROOM(2500000, 32, 235, 636, true, MapBuilder.EAST, MapBuilder.SOUTH, MapBuilder.WEST)
        //done
        ,
        HALL_QUEST(2500000, 35, 237, 638, true, MapBuilder.NORTH, MapBuilder.EAST, MapBuilder.SOUTH, MapBuilder.WEST)
        //done
        ,
        MENAGERIE(3000000, 37, 239, 634, false, MapBuilder.NORTH, MapBuilder.EAST, MapBuilder.SOUTH, MapBuilder.WEST)
        // done
        ,
        STUDY(5000000, 40, 236, 637, true, MapBuilder.EAST, MapBuilder.SOUTH, MapBuilder.WEST),
        // done
        COSTUME_ROOM(5000000, 42, 238, 633, true, MapBuilder.NORTH, MapBuilder.EAST, MapBuilder.SOUTH, MapBuilder.WEST)
        // done
        ,
        CHAPEL(5000000, 45, 234, 637, true, MapBuilder.SOUTH, MapBuilder.WEST)
        // done
        ,
        PORTAL_CHAMBER(10000000, 50, 233, 636, true, MapBuilder.SOUTH)
        // done
        ,
        FORMAL_GARDEN(7500000, 55, 234, 633, false, MapBuilder.NORTH, MapBuilder.EAST, MapBuilder.SOUTH, MapBuilder.WEST)
        // done
        ,
        THRONE_ROOM(15000000, 60, 238, 637, true, MapBuilder.SOUTH),
        OUTBLIETTE(15000000, 65, 238, 635, false, MapBuilder.NORTH, MapBuilder.EAST, MapBuilder.SOUTH, MapBuilder.WEST)
        // done
        ,
        DUNGEON_CORRIDOR(750000, 70, 236, 635, false, MapBuilder.NORTH, MapBuilder.SOUTH)
        // done
        ,
        DUNGEON_JUNCTION(750000, 70, 232, 635, false, MapBuilder.NORTH, MapBuilder.EAST, MapBuilder.SOUTH, MapBuilder.WEST)
        // done
        ,
        DUNGEON_STAIRS(750000, 70, 234, 635, false, MapBuilder.NORTH, MapBuilder.EAST, MapBuilder.SOUTH, MapBuilder.WEST)
        // done
        ,
        DUNGEON_PIT(1000000, 70, 237, 634, false, MapBuilder.NORTH, MapBuilder.EAST, MapBuilder.SOUTH, MapBuilder.WEST)
        // done
        ,
        TREASURE_ROOM(25000000, 75, 239, 636, true, MapBuilder.SOUTH)

        //hall skill down
        ,
        HALL_SKILL_DOWN(1500000, 25, 235, 638, true, MapBuilder.NORTH, MapBuilder.EAST, MapBuilder.SOUTH, MapBuilder.WEST)

        //hall quest down
        ,
        HALL_QUEST_DOWN(2500000, 35, 239, 638, true, MapBuilder.NORTH, MapBuilder.EAST, MapBuilder.SOUTH, MapBuilder.WEST);
    ...
    public static enum POHLocation {
        EDGEVILLE(new Position(3085, 3488), 1, 0),
        RIMMINGTON(new Position(2953, 3225), 1, 50000),
        TAVERLEY(new Position(2882, 3452), 10, 50000),
        POLLNIVNEACH(new Position(3340, 3003), 20, 75000),
        RELLEKKE(new Position(2670, 3631), 30, 100000),
        BRIMHAVEN(new Position(2757, 3178), 40, 150000),
        YANILLE(new Position(2544, 3096), 50, 250000);

        private Position tile;
        private int levelRequired, cost;

        POHLocation(Position tile, int levelRequired, int cost) {
            this.tile = tile;
    ...
    public static final Position[] PORTAL_COORDINATES =
            {
                    new Position(3212, 3424),//Varrock
                    new Position(3222, 3218),//Lumbridge
                    new Position(2964, 3379),//Falador
                    new Position(2757, 3478),//Camelot
                    new Position(2664, 3305),//Ardougne
                    new Position(2547, 3113),//Watchtower
                    new Position(3492, 3471) //Canafis
            };
    ...
    public static final Item[][] BANKABLE_ITEMS =
            {
