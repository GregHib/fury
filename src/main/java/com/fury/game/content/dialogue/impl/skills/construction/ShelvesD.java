 ...
 */
public class ShelvesD extends Dialogue {
    ...
    public void start() {
        ...
        if (currentOptions.size() >= 4) {
            currentOptions.add(4, max_index > 6 ? "Next Page" : "Nothing.");
    ...
    private void sendOptions(boolean secondOptions) {
        String[] strings = new String[max_index > 6 ? secondOptions && max_index != 6 ? max_index - 5 : 5 : max_index == 6 ? 5 : max_index];
