...
public class SachemHoardstalker extends Familiar {
	...
	public SachemHoardstalker(Player owner, Summoning.Pouches pouch, Position tile) {
	...
	public void processNpc() {
		...
		if (forageTicks == 300) {
			forageTicks = 0;
			getBeastOfBurden().add(new Item(DungeonConstants.HOARDSTALKER_ITEMS[9][Misc.random(5)], 1));
		}
	}
	...
	public boolean submitSpecial(Object object) {
		...
		for (Skill skill : CombatConstants.NON_COMBAT_SKILLS)
			player.getSkills().boost(skill, 10);
		return true;
	}
}
