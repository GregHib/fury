...
class LargePouchPlugin : ItemActionEvent() {

    companion object {
        private val RUNE_ESS = Item(1436)
        private val PURE_ESS = Item(7936)
        private val KEY_RUNE = Variables.LARGE_POUCH_RUNE_ESSENCE
        private val KEY_PURE = Variables.LARGE_POUCH_PURE_ESSENCE
        private val size = 9
        private val pouch = 5512
    }
