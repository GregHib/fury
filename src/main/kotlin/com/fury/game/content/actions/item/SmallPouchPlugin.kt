...
class SmallPouchPlugin : ItemActionEvent() {

    companion object {
        private val RUNE_ESS = Item(1436)
        private val PURE_ESS = Item(7936)
        private val KEY_RUNE = Variables.SMALL_POUCH_RUNE_ESSENCE
        private val KEY_PURE = Variables.SMALL_POUCH_PURE_ESSENCE
        private val size = 3
        private val pouch = 5509
    }
