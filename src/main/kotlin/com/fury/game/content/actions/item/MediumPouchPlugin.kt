...
class MediumPouchPlugin : ItemActionEvent() {

    companion object {
        private val RUNE_ESS = Item(1436)
        private val PURE_ESS = Item(7936)
        private val KEY_RUNE = Variables.MEDIUM_POUCH_RUNE_ESSENCE
        private val KEY_PURE = Variables.MEDIUM_POUCH_PURE_ESSENCE
        private val size = 6
        private val pouch = 5510
    }
