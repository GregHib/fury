...
class LowAlchemy : SkillSpell() {
    override val id = 61576
    override val level = 21
    override val experience = 31.0
    override val animation = Optional.of(Animation(712))
    override val graphic = Optional.of(Graphic(112))
    override val staffAnimation = Optional.of(Animation(9633))
    override val staffGraphic = Optional.of(Graphic(1693))
    override val items = Optional.of(arrayOf(Item(554, 3), Item(561)))
    ...
    override fun spellEffect(figure: Figure, context: SpellContext) {
        if(figure is Player && context is SpellOnItemContext) {
            ...
            val value = (item.definitions.value * 0.8).toInt()
            ...
            if(figure.inventory.delete(delete)) {
                ...
                if (value >= 1000000)
                    Achievements.finishAchievement(figure, Achievements.AchievementData.LOW_ALCH_1M_ITEM)
